...
export const createsAr: CreatesContent = {
  ...
  showcase: {
    ...
    descriptions: [
      "تغطية تفعيل العلامة التجارية في واحدة من أكبر ليالي الثقافة",
      ...
      "مسلسل أصلي يُعرض على ROKU",
      "إعلان برعاية Smirnoff بالشراكة مع BET",
      "مبادرة Retool Your School من Home Depot مع Rashan Ali",
      "محتوى برعاية LEGO",
    ],
  },
