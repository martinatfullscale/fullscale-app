...
const logoBlackAmbition = "";
const logoMayDavis = "";
const logoElementa = "";
const logoNue = "";
const heroVideo = "";
const realityImg = "";
const aiAugmentedImg = "";
const surfaceEngineImg = "";
const kitchenFrame = "";
const fitnessFrame = "";
const techFrame = "";
const beautyFrame = "";
...
function SurfaceEngineDemo({ isInView, aspectRatio = "16:9", videoSrc = heroVideo }: { isInView: boolean; aspectRatio?: "16:9" | "9:16"; videoSrc?: string }) {
  ...
  useEffect(() => {
    ...
    // Try to play (silently handle autoplay restrictions)
    video.play().catch(() => {});
  ...
  // Frame extraction (only when video ready, no debug logging)
  useEffect(() => {
