...
export function OnboardingChecklist() {
  ...
  const steps: Array<{ key: string; done: boolean; title: string; detail: string; cta: string; go: () => void }> = [
    ...
    },
    {
      ...
      detail: "Open the scan results, drop a product onto a space you like, and save. You're choosing WHERE the product lives — our team reviews it and produces the final polished render, which lands in your Deliveries ready to post.",
      cta: "Try a placement",
      go: () => navigate("/library"),
    },
  ];
