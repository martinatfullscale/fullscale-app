  ...
  // ─────────────────────────────────────────────
  {
    ...
    faces: [
      ...
      },
      {
        ...
        initials: 'AW',
        options: [
          'Sprawling ancient temple complex reflected in a wide moat in Southeast Asia',
          'Terraced stone temple rising from the Javanese jungle',
          'Golden-spired royal palace compound in a Southeast Asian capital',
          'Crumbling brick temple towers surrounded by jungle vines in Myanmar',
        ],
        hints: [
          [
            'Sprawling ancient temple complex reflected in a wide moat in Southeast Asia',
      ...
      },
      {
        ...
        initials: 'MR',
        options: [
          'Four giant presidential faces carved into a granite mountainside',
          'Colossal seated pharaoh statues flanking a temple entrance in the desert',
          'Enormous rock carving of a warrior chief on horseback in the American West',
          'Giant stone heads half-buried in the jungle floor of Central America',
        ],
        hints: [
          [
            'Four giant presidential faces carved into a granite mountainside',
      ...
      },
      {
        ...
        initials: 'SH',
        options: [
          'Mysterious ring of massive standing stones on a windswept English plain',
          'Towering stone pillars of an ancient Greek temple on a hilltop',
          'Rows of thousands of upright stones stretching across fields in France',
          'Lone stone fortress balanced on a rocky desert butte in the Southwest',
        ],
        hints: [
          [
            'Mysterious ring of massive standing stones on a windswept English plain',
      ...
      },
      {
        ...
        initials: 'BK',
        options: [
          'Gleaming supertall skyscraper soaring above a modern desert city',
          'Twin glass towers connected by a sky bridge in Southeast Asia',
          'Art Deco skyscraper with a steel crown towering over midtown Manhattan',
          'Twisted glass tower spiraling upward in a modern European capital',
        ],
        hints: [
          [
            'Gleaming supertall skyscraper soaring above a modern desert city',
      ...
      },
      {
        ...
        initials: 'LP',
        options: [
          'Famous white marble tower tilting noticeably to one side in Italy',
          'Round stone tower perched on a dramatic Irish sea cliff',
          'Ornate medieval clock tower in the center of a European piazza',
          'Tall minaret spiraling upward beside a grand mosque in the Middle East',
        ],
        hints: [
          [
            'Famous white marble tower tilting noticeably to one side in Italy',
      ...
      },
      {
        ...
        initials: 'CI',
        options: [
          'Ancient stepped pyramid where a serpent shadow appears at the equinox',
          'Massive flat-topped pyramid towering over an ancient avenue near a modern capital',
          'Steep jungle pyramid rising above the canopy in the rainforests of Guatemala',
          'Ruined hilltop fortress overlooking a sacred valley in the Andes',
        ],
        hints: [
          [
            'Ancient stepped pyramid where a serpent shadow appears at the equinox',
      ...
      },
      {
        ...
        initials: 'SF',
        options: [
          'Soaring unfinished basilica with fantastical spires in a Spanish city',
          'Enormous Gothic cathedral with flying buttresses in the heart of Paris',
          'Ornate domed cathedral dominating the skyline of Florence',
          'Grand white marble cathedral with golden domes on a Moscow riverbank',
        ],
        hints: [
          [
            'Soaring unfinished basilica with fantastical spires in a Spanish city',
      ...
      },
      {
        ...
        initials: 'NF',
        options: [
          'Thundering curtain of water plunging over a cliff on a US-Canadian border',
          'Towering tropical waterfall plunging from a flat-topped mountain in South America',
          'Wide cascade of hundreds of waterfalls stretching across a jungle river in South America',
          'Dramatic narrow waterfall dropping into a deep gorge in an African national park',
        ],
        hints: [
          [
            'Thundering curtain of water plunging over a cliff on a US-Canadian border',
  ...
  // ─────────────────────────────────────────────
  {
    ...
    faces: [
      ...
      },
      {
        ...
        initials: '🏄',
        options: [
          'Someone balancing on a moving surface over water',
          'A person paddling a boat through calm waters',
          'Someone diving headfirst into a swimming pool',
          'A person wading through a shallow stream',
        ],
        hints: [
          [
            'Someone balancing on a moving surface over water',
      ...
      },
      {
        ...
        initials: '🪢',
        options: [
          'A group of people pulling something with all their strength',
          'Children racing each other across a grassy field',
          'A team lifting a heavy object together off the ground',
          'Kids forming a human chain to cross a muddy area',
        ],
        hints: [
          [
            'A group of people pulling something with all their strength',
      ...
      },
      {
        ...
        initials: '🎂',
        options: [
          'A person leaning forward and blowing air at small flames',
          'Someone carefully lighting a row of candles on a mantel',
          'A person opening a wrapped gift with excitement',
          'Someone stirring batter in a large mixing bowl',
        ],
        hints: [
          [
            'A person leaning forward and blowing air at small flames',
      ...
      },
      {
        ...
        initials: '🎨',
        options: [
          'Someone creating something visual using tools held in their hand',
          'A person arranging framed pictures on a wall',
          'Someone writing notes on a whiteboard in a classroom',
          'A person assembling a model from small pieces at a desk',
        ],
        hints: [
          [
            'Someone creating something visual using tools held in their hand',
      ...
      },
      {
        ...
        initials: '🐕',
        options: [
          'Someone moving along a path with an animal beside them',
          'A person jogging alone through a park at dawn',
          'Someone sitting on a bench feeding birds in a plaza',
          'A person pushing a stroller down a sidewalk',
        ],
        hints: [
          [
            'Someone moving along a path with an animal beside them',
      ...
      },
      {
        ...
        initials: '🎣',
        options: [
          'A person swinging a long thin object in an arc toward water',
          'Someone throwing a net from the edge of a boat',
          'A person skipping stones across the surface of a lake',
          'Someone rowing a small boat through misty water',
        ],
        hints: [
          [
            'A person swinging a long thin object in an arc toward water',
      ...
      },
      {
        ...
        initials: '🎠',
        options: [
          'Children spinning around on a colorful moving structure',
          'Kids sliding down a tall curved slope one after another',
          'Children swinging back and forth high in the air',
          'Kids climbing up a rope structure in a playground',
        ],
        hints: [
          [
            'Children spinning around on a colorful moving structure',
      ...
      },
      {
        ...
        initials: '🧘',
        options: [
          'A person holding a still pose with their body in an unusual position',
          'Someone stretching before going on a run',
          'A person meditating with their eyes closed and legs crossed',
          'Someone doing push-ups on a gym floor',
        ],
        hints: [
          [
            'A person holding a still pose with their body in an unusual position',
      ...
      },
      {
        ...
        initials: '🚒',
        options: [
          'A person in heavy gear directing a powerful stream of water',
          'Someone using a pressure washer to clean a driveway',
          'A person watering a garden with a hose on a sunny day',
          'Someone operating a large industrial machine that sprays liquid',
        ],
        hints: [
          [
            'A person in heavy gear directing a powerful stream of water',
      ...
      },
      {
        ...
        initials: '💈',
        options: [
          'A person using a tool to trim something on another persons head',
          'Someone styling hair with a curling iron at a salon',
          'A person applying makeup to a clients face in a chair',
          'Someone massaging another persons shoulders in a spa',
        ],
        hints: [
          [
            'A person using a tool to trim something on another persons head',
  ...
  // ─────────────────────────────────────────────
  {
    ...
    faces: [
      ...
      },
      {
        ...
        initials: '🌍',
        options: [
          'A round decorative object that sits on a stand and can be spun',
          'A circular wall clock with Roman numerals and ornate hands',
          'A round ceramic vase with painted patterns from around the world',
          'A spherical lamp that casts patterned shadows on the walls',
        ],
        hints: [
          [
            'A round decorative object that sits on a stand and can be spun',
      ...
      },
      {
        ...
        initials: '🌵',
        options: [
          'A green living thing that sits on a windowsill and rarely needs attention',
          'A potted fern with delicate fronds cascading over the edge of a shelf',
          'A small bonsai tree carefully shaped with twisted branches and tiny leaves',
          'A jar of preserved green vegetables sitting on a kitchen counter',
        ],
        hints: [
          [
            'A green living thing that sits on a windowsill and rarely needs attention',
      ...
      },
      {
        ...
        initials: '🫧',
        options: [
          'A glowing object that slowly changes shape on its own while sitting on a surface',
          'A flickering candle in a tall glass holder casting dancing shadows',
          'A neon sign tube bent into a decorative shape and plugged into the wall',
          'A fiber optic spray lamp with strands that change color at the tips',
        ],
        hints: [
          [
            'A glowing object that slowly changes shape on its own while sitting on a surface',
      ...
      },
      {
        ...
        initials: '🧯',
        options: [
          'A sturdy metal object found outdoors on sidewalks in most neighborhoods',
          'A metal mailbox mounted on a post at the end of a residential driveway',
          'A cast iron street bollard protecting a sidewalk corner from vehicles',
          'A metal parking meter standing on the curb next to a road',
        ],
        hints: [
          [
            'A sturdy metal object found outdoors on sidewalks in most neighborhoods',
      ...
      },
      {
        ...
        initials: '🕰️',
        options: [
          'A tall piece of furniture that makes a repetitive sound and stands against a wall',
          'A large wooden bookshelf filled with leather-bound volumes in a study',
          'A tall narrow wooden cabinet used for storing china and glassware',
          'A standing wooden coat rack with multiple hooks near a front door',
        ],
        hints: [
          [
            'A tall piece of furniture that makes a repetitive sound and stands against a wall',
      ...
      },
      {
        ...
        initials: '🔭',
        options: [
          'A long tube-shaped instrument mounted on a stand, used for looking at distant things',
          'A large camera with a very long zoom lens on a heavy tripod',
          'A metal tube used as a level or surveying tool on a construction tripod',
          'A cylindrical rain gauge mounted on a post in a backyard garden',
        ],
        hints: [
          [
            'A long tube-shaped instrument mounted on a stand, used for looking at distant things',
      ...
      },
      {
        ...
        initials: '🧳',
        options: [
          'A rectangular container with a handle on top, designed to be carried when traveling',
          'A wooden chest with a flat lid used for storing blankets at the foot of a bed',
          'A leather briefcase with metal clasps carried to business meetings',
          'A wicker picnic basket with a hinged lid and handles on the sides',
        ],
        hints: [
          [
            'A rectangular container with a handle on top, designed to be carried when traveling',
      ...
      },
      {
        ...
        initials: '🍿',
        options: [
          'A tall machine with a glass enclosure that makes a popular snack using heat',
          'A glass-doored vending machine filled with rows of candy bars and chips',
          'A cotton candy spinner with a large metal bowl on top of a wheeled cart',
          'A glass display case at a bakery counter showing rows of fresh pastries',
        ],
        hints: [
          [
            'A tall machine with a glass enclosure that makes a popular snack using heat',
      ...
      },
      {
        ...
        initials: '🎶',
        options: [
          'A flat device with a spinning part that plays music using a physical medium',
          'A portable CD player with headphones attached sitting on a desk',
          'A cassette tape deck with mechanical buttons built into a stereo system',
          'A digital music streaming speaker shaped like a cylinder on a shelf',
        ],
        hints: [
          [
            'A flat device with a spinning part that plays music using a physical medium',
      ...
      },
      {
        ...
        initials: '🧯',
        options: [
          'A heavy red metal cylinder found mounted on walls in buildings',
          'A tall red thermos bottle used for keeping drinks hot at a worksite',
          'A red metal propane tank connected to a portable camping grill',
          'A red compressed air canister used to inflate flat bicycle tires',
        ],
        hints: [
          [
            'A heavy red metal cylinder found mounted on walls in buildings',
