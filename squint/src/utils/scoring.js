 ...
 * Stage 2 (after 1 wrong):  200 pts
 * Stage 3 (after 2 wrong):   50 pts
 * Stage 4 (after 3 wrong):    0 pts
...
export function getScoreLabel(score) {
  if (score >= 3501) return 'Eagle Vision';
  if (score >= 2001) return 'Sharp Eyes';
  if (score >= 801) return 'Getting Warmer';
